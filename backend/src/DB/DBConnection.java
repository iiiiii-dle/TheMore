...
//	private static String password = "20240320!!"; // Password
	...
	private static final String location = "/"; // 테스트용입니다.
	private static final String databaseName = ""; // 테스트용입니다. 
	private static final String userName = ""; // 테스트용입니다.
	private static String password = "!!"; // 테스트용입니다.
